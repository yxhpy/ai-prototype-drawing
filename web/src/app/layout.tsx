...
// 导入项目组件注册
import '@/components/prototypes/campus-food-delivery';
// 如果有其他项目，也在这里导入它们的注册文件
// import '@/components/prototypes/video-generation';
// import '@/components/prototypes/user-auth';
// import '@/components/prototypes/product';
